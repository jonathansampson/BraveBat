        ...
        <div class="text-center md:text-left md:flex">
            ...
            <div class="pt-3 md:w-1/4">
                ...
                <div class="flex justify-center pt-1 pb-4 space-x-2 md:justify-start">
                    <div class="w-6 h-6">
                        <a href="mailto:bravebatinfo@gmail.com" aria-label="Email"
                            ...
                            <svg viewBox="0 0 448 448" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                ...
                                <path
                                    d="M224 240a7.986 7.986 0 01-5.207-1.93L120 153.39V304h208V153.39l-98.793 84.68A7.986 7.986 0 01224 240zm0 0" />
                                <path
                                    d="M224 0C100.29 0 0 100.29 0 224s100.29 224 224 224 224-100.29 224-224C447.86 100.348 347.652.14 224 0zm120 312a8 8 0 01-8 8H112a8 8 0 01-8-8V136a8 8 0 018-8h224a8 8 0 018 8zm0 0" />
                            </svg>
                        </a>
                    </div>
                    <div class="w-6 h-6">
                        <a href="https://twitter.com/BraveBatInfo" aria-label="Twitter"
                            class="text-gray-500 hover:text-gray-300">
                    ...
                    <div class="w-6 h-6">
                        <a href="https://github.com/husonghua" aria-label="Github"
                            class="text-gray-500 hover:text-gray-300">
                    ...
                    <div class="w-6 h-6">
                        <a href="https://www.reddit.com/r/BATProject/" aria-label="Reddit"
                            class="text-gray-500 hover:text-gray-300">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                <path
                    ...
                    <div class="w-6 h-6">
                        <a href="https://t.me/batproject" aria-label="Telegram"
                            class="text-gray-500 hover:text-gray-300">

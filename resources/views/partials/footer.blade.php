<div class="bg-gray-800">
    <footer class="container px-4 py-6 mx-auto sm:px-6 md:px-8 text-brand-light">
        <div class="text-center md:text-left md:flex ">
            ...
            <div class="pt-3 md:w-1/3">
                ...
                <div class="flex justify-center pt-1 pb-4 space-x-2 md:justify-start">
                    <div class="w-6 h-6">
                        <a href="mailto:support@bravebat.info" aria-label="Email" class="text-gray-500 hover:text-gray-300">
        ...
        <div class="pt-4 pb-4 text-xs italic text-center">
            This site is unofficial and not affiliated with Brave Software. If you like the site, please support us by downloading the Brave Browser using <a href="{{config('bravebat.referral_link')}}" class="underline">our referral link</a>.
        </div>
    </footer>

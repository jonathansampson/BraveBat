...
@section('title', 'BraveBat Privacy Policy')
...
<div class="container px-4 pb-8 mx-auto sm:px-6 md:px-8">
    ...
    <div class="leading-6">
        <p class="pt-4">
            BraveBat is not in the business of making money off your data, and we do not serve ads. Everything we collect is used exclusively to help us provide you with the best service possible.
        </p>
        <h2 class="pt-6 text-lg font-semibold">
            Identity & Access
        </h2>
        <p class="pt-4">
            When you sign up for BraveBat, we ask for your name and email address. That’s just so you can personalize your new account. We’ll never sell or rent your personal info to third parties, and we won’t use your name or company in marketing statements without your permission, either.
        </p>
        <p class="pt-4">
            When you contact BraveBat with a question or to ask for help, we’ll keep that correspondence, and the email address, for future reference. When you browse our marketing pages, we’ll track that for statistical purposes (like conversion rates and to test new designs). We also store any information you volunteer, like surveys, for as long as it makes sense.
        </p>
        <h2 class="pt-6 text-lg font-semibold">
            Your Rights With Respect to Your Information
        </h2>
        <p class="pt-4">
            You may have heard about the General Data Protection Regulation (“GDPR”) in Europe. GDPR gives people under its protection certain rights with respect to their personal information collected by us on the Site. Accordingly, BraveBat recognizes and will comply with GDPR and those rights, except as limited by applicable law. The rights under GDPR include:
        </p>
        <ul class="pt-4 list-inside">
            <li class="list-disc">Right of Access.</li>
            <li class="list-disc">Right to Correction.</li>
            <li class="list-disc">Right to Erasure.</li>
            <li class="list-disc">Right to Complain.</li>
            <li class="list-disc">Right to Restrict Processing.</li>
            <li class="list-disc">Right to Object.</li>
            <li class="list-disc">Right to Portability.</li>
            <li class="list-disc">Right to not be subject to Automated Decision-Making.</li>
        </ul>
        <h2 class="pt-6 text-lg font-semibold">
            Processors we use
        </h2> 
        ...
        <ul class="pt-4 list-inside">
            <li class="list-disc">CloudFlare
                (<a href="https://www.cloudflare.com/privacypolicy/" class="text-blue-500">Privacy Policy</a>)
            </li>
            <li class="list-disc">Google Analytics
                (<a href="https://policies.google.com/privacy?hl=en-US" class="text-blue-500">Privacy Policy</a>)
            </li>
        </ul>
        <h2 class="pt-6 text-lg font-semibold">
        ...
        <p class="pt-4">
            BraveBat won’t hand your data over to law enforcement unless a court order says we have to. We flat-out reject requests from local and federal law enforcement when they seek data without a court order. And unless we’re legally prevented from it, we’ll always inform you when such requests are made.
        </p>
